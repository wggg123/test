      ...
      <div class="goods">
        <div class="left-good">
          ...
          <div class="right-info">
            ...
            <p class="attr">
              <span v-for="spu in spuInfo" :key="spu.id">{{spu.saleAttrName}} :
                <template v-for="spuAttr in spu.spuSaleAttrValueList">
                  <span :key="spuAttr.id" v-if="spuAttr.isChecked==1">{{spuAttr.saleAttrValueName}}</span>
                </template>
              </span>
              <span>数量：{{skuNum}}</span>
            </p>
